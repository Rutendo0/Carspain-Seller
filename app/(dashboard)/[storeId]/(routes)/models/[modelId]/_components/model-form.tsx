...
import { Billboards, Brand, Category, Model } from "@/types-db"
...
export const ModelForm = ({initialData, brands}: ModelFormProps) => {
    ...
    const description = initialData ? "Edit a Model" : "Create a new Model";
    const toastMessage = initialData ? "Model Updated" : "Created Model";
    const action = initialData ? "Save Changes" : "Create Model";
    ...
    const onSubmit = async (data : z.infer<typeof formSchema>) => {
        try {
            ...
            const {brandId: formBrandId} = form.getValues()
  ...
  return <>
    ...
    <Form {...form}>
                    ...
                    className="w-full space-y-8">
                        ...
                        <FormField control={form.control} name="brandId"
                        render={({field}) => (
                            <FormItem>
