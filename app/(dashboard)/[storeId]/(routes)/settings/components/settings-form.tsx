...
const formSchema = z.object({
    name: z.string()
    .min(3,{message:"Store name should be atleast 3 characters"})
});



export const SettingsForm = ({initialData}: SettignsFormProps) => {
  ...
  return <>
    ...
    <div className="flex items-center justify-center">
        ...
        onClick={()=>setOpen(true)}><Trash className="h-4 w-4"/></Button>
    </div>
